  ...
  <div>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">ویرایش دسته</h1>
          </div>
          <div class="col-sm-6">
            <ul class="breadcrumb">
...
export default {
  ...
  methods: {
    updateCategory() {
      ...
      this.$store.dispatch("updateCategory", edit);
    },
    allParent: function () {
      let app = this;
      this.axios
    ...
    editCategory() {
      let app = this;
      this.axios
        .get("admin/categories/edit/" + this.id)
        .then(function (response) {
          app.name=response.data.data.name
          app.lname=response.data.data.lname
          app.parent_id=response.data.data.parent_id
